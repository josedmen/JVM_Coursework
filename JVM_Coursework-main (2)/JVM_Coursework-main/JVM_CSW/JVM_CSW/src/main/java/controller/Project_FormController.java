...
public class Project_FormController implements Initializable {
    ...
    private String saveData() {
        ...
        try {
            ...
            String kid = child.getChildren();

            HashMap<String,List<String>> ChildList = new HashMap<>();// right now just for reference
            List<String> kids = new ArrayList<String>();
            List<String> children = new ArrayList<String>();//this value passed to the project factory creator and saving
                                                            //and successfully saved to the file
            kids.add("children");//key value of the map

            children.add(kid);// Values inside the list

            ChildList.put(kids.get(0),children );

            String kiddos = gson1.toJson(ChildList);

            System.out.println(kiddos); // visual of the hashmap
